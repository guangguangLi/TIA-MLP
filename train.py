...
def parse_args():
    ...
    # model
    parser.add_argument('--arch', '-a', metavar='ARCH', default='TIA')
...
def main():
    ...
    #train_img_ids, val_img_ids = train_test_split(train_val_img_ids, test_size=0.125, random_state=41)
